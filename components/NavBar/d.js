...
// {/* <!-- ========== HEADER ========== --> */}
{
  /* <header classNameName="sticky inset-x-0 top-0 z-[48] flex w-full flex-wrap border-b bg-white/[.6] px-4  py-2.5 text-sm backdrop-blur-lg dark:border-gray-700 dark:bg-gray-800 sm:flex-nowrap sm:justify-start sm:py-4 lg:pl-64">
        <nav
          classNameName="mx-auto flex w-full basis-full  items-center px-4 sm:px-6 md:px-8"
          aria-label="Global"
        >
          <div classNameName="mr-5 lg:mr-0 lg:hidden">
            <Link
              href="/"
              key={1}
              classNameName="mr-auto flex-none"
              aria-label="Go home"
            >
              <>
                <span classNameName="sr-only">AMA Sundays Farmers Market</span>
                <Image
                  classNameName="dark:invert md:h-10 md:w-14"
                  src={logo}
                  alt="AMA Sundays Farmers Market"
                  quality={90}
                  width={110.5}
                  height={40.75}
          ...
          <div classNameName="relative flex  py-[0.525rem]">
            <Link classNameName="mr-auto flex-none text-slate-900" href="/">
              <>
                <span classNameName="sr-only">Tailwind UI</span>
                <svg
                  classNameName="h-6 w-auto"
                  aria-hidden="true"
                  viewBox="0 0 160 24"
                  fill="none"
                >
            ...
            <div classNameName="hidden lg:flex lg:items-center">
              <Link href="/components">Components</Link>
              <Link classNameName="ml-8" href="/templates">
                Templates
              </Link>
              <div classNameName="ml-2 hidden rounded-full bg-sky-500 px-1.5 py-0.5 text-xs text-white sm:block">
                New
              </div>
              <Link classNameName="ml-8" href="/documentation">
                Documentation
              </Link>
            </div>
            <button
              type="button"
              classNameName="-my-1 ml-8 flex h-8 w-8 items-center justify-center rounded-lg"
            >
              <span classNameName="sr-only">Search components</span>
              <svg
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                classNameName="h-6 w-6 fill-gray-900 hover:fill-gray-900"
              >
            ...
            <button
              type="button"
              classNameName="-my-1 ml-6 -mr-1 flex h-8 w-8 items-center justify-center lg:hidden"
            >
              <span classNameName="sr-only">Open navigation</span>
              <svg viewBox="0 0 24 24" classNameName="h-6 w-6 stroke-slate-900">
                <path
            ...
            <div classNameName="lg:border-slate-900/15 hidden lg:ml-8 lg:flex lg:items-center lg:border-l lg:pl-8">
              <a href="/login">Sign in</a>
              <a
                classNameName="-my-2.5 ml-8 inline-flex justify-center rounded-lg bg-slate-900 py-2.5 px-4 text-sm font-semibold text-white hover:bg-slate-700"
                href="/all-access"
              >
                <span>
