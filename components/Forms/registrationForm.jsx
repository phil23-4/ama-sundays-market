    ...
    <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      ...
      <div className="grid items-center gap-12 md:grid-cols-2">
        <div>
          ...
          <p className="mt-1 text-gray-800 dark:text-gray-200 md:text-lg">
          ...
          <div className="mt-8">
            ...
            <ul className="mt-2 space-y-2">
              <li className="flex space-x-3">
                <svg
                  className="h-6 w-6 flex-shrink-0 text-gray-600 dark:text-gray-400"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
          ...
          <div className="mt-10 flex items-center gap-x-5">
            ...
            <div className="flex -space-x-2">
              ...
              <img
                ...
                alt="Image Description"
              />
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary/90 text-white ring-2 ring-white">
                <svg
              ...
              <div className="mt-6 grid gap-4 lg:gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="required block w-full rounded-md border-gray-200 py-3 px-4 text-sm focus:border-primary/90 focus:ring-primary/90 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400"
                  />
                </div>
