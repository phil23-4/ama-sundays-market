<section class="relative pt-24 pb-32 bg-white overflow-hidden">
  ...
  <div class="relative z-10 container px-4 mx-auto">
    <h2 class="mb-16 text-6xl md:text-7xl font-bold font-heading text-center tracking-px-n leading-tight">Don&apos;t just take our word for it</h2>
        ...
        <div class="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
          <div class="flex flex-col justify-between h-full">
            <div class="mb-5 block">
              <div class="flex flex-wrap mb-4 -m-2">
                <div class="w-auto p-2">
                  <img src="flaro-assets/images/testimonials/avatar2.png" alt="">
                </div>
                <div class="w-auto p-2">
        ...
        <div class="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
          <div class="flex flex-col justify-between h-full">
            <div class="mb-5 block">
              <div class="flex flex-wrap mb-4 -m-2">
                <div class="w-auto p-2">
                  <img src="flaro-assets/images/testimonials/avatar3.png" alt="">
                </div>
                <div class="w-auto p-2">
        ...
        <div class="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
          <div class="flex flex-col justify-between h-full">
            <div class="mb-5 block">
              <div class="flex flex-wrap mb-4 -m-2">
                <div class="w-auto p-2">
                  <img src="flaro-assets/images/testimonials/avatar5.png" alt="">
                </div>
                <div class="w-auto p-2">
        ...
        <div class="p-6 h-full bg-white bg-opacity-60 border rounded-4xl">
          <div class="flex flex-col justify-between h-full">
            <div class="mb-5 block">
              <div class="flex flex-wrap mb-4 -m-2">
                <div class="w-auto p-2">
                  <img src="flaro-assets/images/testimonials/avatar6.png" alt="">
                </div>
                <div class="w-auto p-2">
