      ...
      <div className="mx-auto max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-center gap-5 text-center md:grid-cols-3">
          ...
          <ul className="text-center">
            <li className="relative inline-block pr-8 before:absolute before:top-1/2 before:right-3 before:-translate-y-1/2 before:text-gray-300 before:content-['/'] last:pr-0 last-of-type:before:hidden dark:before:text-gray-600">
              <a
