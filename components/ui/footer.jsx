  ...
  return (
    <section className="overflow-hidden bg-white pt-24">
      <div className="container mx-auto px-4">
          ...
          <div className="-m-8 flex flex-wrap">
            ...
            <div className="w-full p-8 sm:w-1/2 lg:w-4/12">
              <div className="lg:max-w-sm">
                ...
                <div className="mb-3 inline-block w-full overflow-hidden rounded-xl border border-gray-300 focus-within:ring focus-within:ring-indigo-300 md:max-w-xl xl:pl-6">
                  <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full xl:w-auto">
                      <div className="block">
                        <button
                          className="w-full border border-indigo-700 bg-indigo-600 py-4 px-8 font-semibold text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus:ring focus:ring-indigo-300"
                          type="button"
                        >
                          Subscribe
                        </button>
        ...
        <div className="-m-4 flex flex-wrap items-center justify-between py-6">
